...
export const HeroSection = ({ stats }: HeroSectionProps) => {
  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-green-50 via-white to-green-50 dark:from-zinc-900 dark:via-zinc-950 dark:to-zinc-900 transition-colors duration-500">
      ...
      {/* Glow */}
      <div className="absolute -top-20 -left-20 w-96 h-96 bg-green-200 dark:bg-green-800 rounded-full blur-3xl opacity-20" />
      <div className="absolute -bottom-20 -right-20 w-96 h-96 bg-yellow-200 dark:bg-yellow-800 rounded-full blur-3xl opacity-20" />

      <div className="relative max-w-7xl mx-auto px-6 lg:px-8 py-16 md:py-24">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          {/* === KIRI === */}
          <div className="space-y-8">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-green-100 dark:bg-green-900/30 border border-green-200 dark:border-green-800 rounded-full text-sm font-medium text-green-700 dark:text-green-300">
              <span>🌿</span> Platform UMKM Desa Terpercaya
            </div>

            <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold text-gray-900 dark:text-white leading-tight font-made-tommy">
              Kebumify
            </h1>
          ...
          <div className="relative">
            <div className="absolute inset-0 bg-gradient-to-br from-green-100 to-yellow-100 dark:from-zinc-800 dark:to-zinc-900 rounded-3xl rotate-1 sm:rotate-2 md:rotate-3" />
            <div className="relative bg-white dark:bg-zinc-900 rounded-3xl shadow-2xl p-6 sm:p-8 transform -rotate-3 sm:-rotate-2 md:-rotate-3 hover:rotate-0 active:rotate-0 transition-transform duration-500">
              <div className="grid grid-cols-2 gap-4">
                {Object.entries(productImages).map(([key, src]) => (
                  <div
                    key={key}
                    className="group bg-gradient-to-br from-white to-green-50 dark:from-zinc-800 dark:to-zinc-900 rounded-2xl p-4 shadow-md hover:shadow-lg active:shadow-inner transition-all duration-300 active:scale-95"
                  >
                    ...
                    <p className="text-sm font-semibold text-gray-900 dark:text-white capitalize text-center">
                      {key}
                    </p>
                  </div>
                ))}
        ...
        >
          <defs>
            <linearGradient id="waveGradient" x1="0" x2="0" y1="0" y2="1">
              <stop offset="0%" className="text-white dark:text-zinc-900" stopColor="currentColor" />
              <stop offset="100%" className="text-green-50 dark:text-zinc-950" stopColor="currentColor" />
            </linearGradient>
          </defs>
          <path
